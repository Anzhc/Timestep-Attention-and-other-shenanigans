We provided example of code we used to test harcoded changes using Kohya scripts through Derrian easy trainer: [files](https://github.com/Anzhc/Timestep-Attention-and-other-shenanigans/tree/main/Kohya%20file%20examples)
